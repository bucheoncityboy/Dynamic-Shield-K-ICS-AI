...
| 80% Fixed | -0.28% | -10.13 | -0.83% | 0.37 | 0.1018 | -0.30억 |
| Rule-based | -0.07% | -4.88 | -1.11% | 0.96 | 0.1033 | -0.01억 |
| **Dynamic Shield** | **0.00%** | **-4.09** | **-1.24%** | **1.22** | **0.1037** | **+0.07억** |

✅ **Dynamic Shield가 유일하게 수익(+0.07억) 달성 및 모든 지표 1위**
